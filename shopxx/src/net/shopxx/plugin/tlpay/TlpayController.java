 ...
 * @version 3.0
 */
@Controller("adminTlpayController")
@RequestMapping("/admin/payment_plugin/tlpay")
public class TlpayController extends BaseController {

	@Resource(name = "tlpayPlugin")
	private TlpayPlugin tlpayPlugin;
	...
	public @ResponseBody
	Message install() {
		if (!tlpayPlugin.getIsInstalled()) {
			PluginConfig pluginConfig = new PluginConfig();
			pluginConfig.setPluginId(tlpayPlugin.getId());
	...
	Message uninstall() {
		if (tlpayPlugin.getIsInstalled()) {
			PluginConfig pluginConfig = tlpayPlugin.getPluginConfig();
	...
	public String setting(ModelMap model) {
		...
		return "/net/shopxx/plugin/tlpay/setting";
	}
