...
public class RegisterController extends BaseController {
	...
	Message submit(String captchaId, String captcha, String username, String email, HttpServletRequest request, HttpServletResponse response, HttpSession session) {
		...
		//获取会员注册时填写的推荐码    柯裕荣   2015-4-11 15:27:17
		String referrerCode= member.getAttributeValue0();
		...
		Message msg= memberService.save(member,referrerCode);
		if(Message.Type.error==msg.getType()){
			return msg;
		}
