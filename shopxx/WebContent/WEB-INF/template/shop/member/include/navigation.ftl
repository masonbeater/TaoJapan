	...
	<div class="menu">
		...
		<div class="content">
			<dl>
				...
				<dd>
					<a href="${base}/member/point/list.jhtml"[#if current == "pointList"] class="current"[/#if]>${message("shop.member.point.list")}</a>
				</dd>
				<dd>
					<a href="${base}/member/point/recom_list.jhtml"[#if current == "recomMemberList"] class="current"[/#if]>${message("shop.member.point.recomMember")}</a>
				</dd>
			</dl>
			<dl>
