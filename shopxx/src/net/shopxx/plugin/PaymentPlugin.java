...
public abstract class PaymentPlugin implements Comparable<PaymentPlugin> {
	 ...
	 * @return 请求参数
	 */
	public abstract Map<String, Object> getSubmitParameterMap(String sn, String description, HttpServletRequest request);
	 ...
	 * @return 请求参数
	 */
	public abstract Map<String, Object> getRefundParameterMap(String sn, String description, Refunds refunds);
	 ...
	 * @return 通知是否合法
	 */
	public abstract boolean verifySubmitNotify(String sn, NotifyMethod notifyMethod, HttpServletRequest request);
	 ...
	 * @return 通知是否合法
	 */
	public abstract boolean verifyRefundNotify(String sn, String response);
