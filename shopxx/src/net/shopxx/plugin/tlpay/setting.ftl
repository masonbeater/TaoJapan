...
<title>${message("admin.plugin.tlpay.setting")} - Powered By SHOP++</title>
...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.jhtml">${message("admin.path.index")}</a> &raquo; ${message("admin.plugin.tlpay.setting")}
	</div>
	<form id="inputForm" action="update.jhtml" method="post">
		<table class="input">
			...
			<tr>
				<th>
					<span class="requiredField">*</span>${message("admin.plugin.tlpay.partner")}:
				</th>
				<td>
			...
			<tr>
				<th>
					<span class="requiredField">*</span>${message("admin.plugin.tlpay.key")}:
				</th>
				<td>
