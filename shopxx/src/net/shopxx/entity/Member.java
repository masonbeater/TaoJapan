...
public class Member extends BaseEntity {
	...
	/**	受邀请人 */
	private Set<Member> invites=new HashSet<Member>();
	 ...
	 */
	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "referrer", nullable = false, updatable = false)
	...
	@OrderBy("createDate desc")
	public Set<Member> getInvites() {
		return invites;
	}
    /**
     * 设置受邀人员
     */
	public void setInvites(Set<Member> invites) {
